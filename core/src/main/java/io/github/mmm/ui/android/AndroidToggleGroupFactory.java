...
/**
 * Implementation of {@link UiToggleGroupFactory} for android.
 *
 * @since 1.0.0
 */
public class AndroidToggleGroupFactory implements UiToggleGroupFactory {

  @Override
  public UiToggleGroup create() {

    return new AndroidToggleGroup();
  }
