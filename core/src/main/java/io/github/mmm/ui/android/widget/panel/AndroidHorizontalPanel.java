...
/**
 * Implementation of {@link UiHorizontalPanel} for android.
 *
 * @since 1.0.0
 */
public class AndroidHorizontalPanel extends AndroidMutablePanel<LinearLayout> implements UiHorizontalPanel {

  /**
   * The constructor.
   */
  public AndroidHorizontalPanel() {
