...
image:https://img.shields.io/github/license/m-m-m/ui-android.svg?label=License["Apache License, Version 2.0",link=https://github.com/m-m-m/ui-android/blob/main/LICENSE]
...
image:https://img.shields.io/maven-central/v/io.github.m-m-m/mmm-ui-android-all.svg?label=Maven%20Central["Maven Central",link=https://search.maven.org/search?q=g:io.github.m-m-m]
image:https://javadoc.io/badge2/io.github.m-m-m/mmm-ui-android-core/javadoc.svg["JavaDoc",link=https://javadoc.io/doc/io.github.m-m-m/mmm-ui-android-core]

The modules `mmm-ui-android-*` provide the implementation of the https://github.com/m-m-m/ui-api[mmm-ui-api] for android.
